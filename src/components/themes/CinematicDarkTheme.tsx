...
export default function CinematicDarkTheme({ data }: { data: InvitationData }) {
  ...
  return (
    ...
    >
      ...
      <button onClick={toggleMusic} className="fixed bottom-8 right-8 z-[100] bg-black/50 backdrop-blur-md border border-white/20 p-4 rounded-full text-white hover:bg-white hover:text-black transition-all duration-500 overflow-hidden group">
          <div className="flex items-center gap-2">
            ...
            <span className="font-sans text-[10px] uppercase tracking-widest font-bold max-w-0 overflow-hidden opacity-0 group-hover:max-w-[100px] group-hover:opacity-100 transition-all duration-500 whitespace-nowrap">
