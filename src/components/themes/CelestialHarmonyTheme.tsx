      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <Card key={i} className="text-center">
                ...
                <h3 className="font-serif text-3xl text-white [text-shadow:0_4px_12px_rgba(0,0,0,0.3)]">{m.n.fullName}</h3>
        ...
        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 1 }} className="space-y-10">
          ...
          <Card className="text-center space-y-8">
            <div className="relative group perspective-1000 max-w-sm mx-auto">
              <div className="relative w-full aspect-[1.6/1] bg-gradient-to-br from-[#1a1a1a] via-[#0d0d0d] to-[#050505] rounded-[1.5rem] border border-white/10 p-6 flex flex-col justify-between overflow-hidden shadow-2xl transition-transform duration-500 group-hover:rotate-y-12">
                {/* Texture Overlay */}
                ...
                <div className="relative z-10 py-1">
                  <p className="text-white text-xl md:text-2xl font-mono tracking-[0.2em] [text-shadow:0_2px_4px_rgba(0,0,0,0.5)]">
            ...
            <button onClick={() => handleCopy(data.gift.accountNumber)} className="w-full py-5 bg-white/5 border border-white/10 text-[#D4AF37] text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-[#D4AF37] hover:text-black transition-all shadow-xl active:scale-95">Salin Rekening</button>
          </Card>
        </motion.div>
            ...
            <AnimatePresence mode="wait">
              {!hasSubmitted ? (
                ...
                >
                  ...
                  <button type="submit" disabled={isSubmitting} className="relative w-full py-5 bg-[#D4AF37] text-black text-[10px] font-black uppercase tracking-[0.3em] rounded-2xl shadow-[0_10px_30px_rgba(212,175,87,0.3)] hover:shadow-[0_15px_40px_rgba(212,175,87,0.5)] active:scale-[0.98] transition-all overflow-hidden group/btn">
        ...
        <div className="pt-32 pb-16 text-center space-y-10 relative">
          ...
          <div className="space-y-4 pt-10">
            ...
            <h2 className="font-serif text-5xl text-white tracking-tighter">{data.bride.name} <span className="text-[#D4AF37]">&</span> {data.groom.name}</h2>
          </div>
    ...
    <div ref={containerRef} className="relative bg-[#020202] selection:bg-[#D4AF37]/30 selection:text-white overflow-x-hidden">
      ...
      <div className="relative" style={{ height: "1600vh" }}>
        ...
        <Sec s={s1}>
          <div className="text-center space-y-10 relative">
            ...
            <h1 className="font-serif text-7xl md:text-[9rem] text-white tracking-tighter leading-none [text-shadow:0_10px_30px_rgba(0,0,0,0.5)]">{data.bride.name} <span className="text-[#D4AF37] block md:inline">&</span> {data.groom.name}</h1>
            ...
            {[
              ...
              <Card key={i} className="flex items-center gap-6 p-4 md:p-6 group">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-serif text-3xl md:text-4xl text-white mb-2 leading-none [text-shadow:0_4px_12px_rgba(0,0,0,0.3)]">{m.n.fullName}</h3>
        ...
        <Sec s={s8}>
          <div className="text-center space-y-8">
            ...
            <Card className="space-y-8 py-10">
              ...
              <div>
                <p className="text-white text-3xl font-mono mb-2">{data.gift.accountNumber}</p>
                <p className="text-white/40 text-[10px] uppercase tracking-widest font-black">a.n. {data.gift.accountName}</p>
              </div>
              <button onClick={() => handleCopy(data.gift.accountNumber)} className="px-10 py-4 bg-[#D4AF37] text-black text-[11px] font-black uppercase tracking-widest rounded-2xl">Salin Rekening</button>
            </Card>
          </div>
        </Sec>
              ...
              <AnimatePresence mode="wait">
                {!hasSubmitted ? (
                  ...
                  >
                    ...
                    <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-[#D4AF37] text-black text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-xl active:scale-95 transition-all">
      ...
      >
        <button 
          ...
          className="group relative flex items-center gap-4 px-8 py-4 bg-black/40 backdrop-blur-2xl border border-white/10 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.5)] active:scale-95 transition-all overflow-hidden"
        >
          ...
          <span className="text-white text-[10px] font-black uppercase tracking-[0.3em]">RSVP Now</span>
