...
const ThemeCatalog = () => {
  ...
  return (
    <div className="pt-32 pb-24 border-t border-wedding-gold/10 transition-colors duration-500 relative overflow-hidden">
      <CornerOrnaments opacity={0.3} size={100} topOffset="top-4 md:top-6" />
