...
export default function ExclusiveProcess() {
  return (
    <section className="py-20 md:py-32 px-4 bg-wedding-base relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-wedding-gold/5 rounded-full blur-[120px] -z-10" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-wedding-gold/5 rounded-full blur-[120px] -z-10" />
