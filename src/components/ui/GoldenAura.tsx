  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-wedding-gold/5 dark:bg-wedding-gold/[0.03] rounded-full blur-[120px]"
      />
      ...
      <motion.div 
        ...
        className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-wedding-gold/5 dark:bg-wedding-gold/[0.02] rounded-full blur-[100px]"
      />
