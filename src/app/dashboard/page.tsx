      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-12">
          ...
          <div className="bg-white p-3 sm:p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 sm:gap-4 hover:border-wedding-gold/20 transition-all">
            ...
            <div className="min-w-0">
              <p className="text-[9px] sm:text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-0.5 sm:mb-1 truncate">Status</p>
              <p className="text-xl sm:text-2xl font-serif font-bold text-gray-800 leading-none">Active</p>
            </div>
          </div>
        </div>
            ...
            invitations.map((invitation) => (
              <div key={invitation.id} className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex flex-col justify-between hover:shadow-lg transition-all">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-gray-100">
                  <a href={`/${invitation.slug}`} target="_blank" className="flex-1 min-w-[70px] text-center py-2 bg-gray-100 text-gray-700 rounded-lg text-[9px] font-bold uppercase tracking-widest hover:bg-gray-200 transition-colors">
                    Lihat
                  </a>
                  <Link href={`/dashboard/edit/${invitation.id}`} className="flex-1 min-w-[70px] text-center py-2 border border-gray-200 text-gray-700 rounded-lg text-[9px] font-bold uppercase tracking-widest hover:border-wedding-gold hover:text-wedding-gold transition-colors">
                    Edit
                  </Link>
                  <Link href={`/dashboard/guests/${invitation.id}`} className="flex-1 min-w-[70px] text-center py-2 bg-wedding-sage/10 text-wedding-sage rounded-lg text-[9px] font-bold uppercase tracking-widest hover:bg-wedding-sage hover:text-white transition-all">
                    Data Tamu
                  </Link>
                  <a 
                    ...
                    target="_blank" 
                    className="w-full flex items-center justify-center gap-1 py-2 mt-1 bg-green-500 text-white rounded-lg text-[9px] font-bold uppercase tracking-widest hover:bg-green-600 transition-colors"
                  >
